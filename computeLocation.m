function [loc,err,antsV,sInfo] = computeLocation(toas,foas,cnrs,satIDs,RxSite)
loc=[];
err=[];
sInfo=[];
%constant
...
[posS,velS,dt]=actualtof(t1,satIDs,RxSite,'downlink');
sInfo.satPos=posS;
sInfo.satVel=velS;
sInfo.toff=dt;
...
[posS1,velS1,~]=actualtof(t2,satIDs,RxSite,'downlink');%for doppler calculation
fd=getDoppler(posS1,velS1,RxSite,fc);
sInfo.foff=fd;
fc1=fc-fd-freq_trns;
sInfo.upFOA=fc1;
